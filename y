...
function OrionLib:MakeWindow(WindowConfig)
	...
	AddConnection(MinimizeBtn.MouseButton1Up, function()
		if Minimized then
			...
			TweenService:Create(MainWindow, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0, WindowName.TextBounds.X + -100, 0, 50)}):Play()
			wait(0.1)
