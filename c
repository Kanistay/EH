...
local function AddDraggingFunctionality(DragPoint, Main)
	pcall(function()
		...
		local CanDrag = true -- Yeni değişken: sürükleme izni
...
function OrionLib:MakeWindow(WindowConfig)
	...
	local function UpdateSize(Input)
		if SizeDragging and (Input.UserInputType == Enum.UserInputType.MouseMovement or Input.UserInputType == Enum.UserInputType.Touch) then
			...
			MainWindow.Size = NewSize -- Animasyonu kaldırdık
			SizeSlider.Slider.Size = UDim2.new(SizeScale, 0, 1, 0) -- Animasyonu kaldırdık
		end
	end
	...
	SizeSlider.InputBegan:Connect(function(Input)
		if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
			SizeDragging = true
			CanDrag = false -- Slider kullanılırken sürüklemeyi devre dışı bırak
		end
	end)
	...
	SizeSlider.InputEnded:Connect(function(Input)
		if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
			SizeDragging = false
			CanDrag = true -- Slider kullanımı bittiğinde sürüklemeyi tekrar etkinleştir
		end
	end)
	...
	local function UpdateTransparency(Input)
		if TransDragging and (Input.UserInputType == Enum.UserInputType.MouseMovement or Input.UserInputType == Enum.UserInputType.Touch) then
			...
			MainWindow.BackgroundTransparency = NewTransparency -- Animasyonu kaldırdık
			TransparencySlider.Slider.Size = UDim2.new(TransScale, 0, 1, 0) -- Animasyonu kaldırdık
		end
	end
